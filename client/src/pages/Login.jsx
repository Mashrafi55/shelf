      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{
            ...
            letterSpacing: '0.1em', color: colors.muted, marginTop: '6px',
          }}>The Digital Library</p>
        </div>

        <div style={{ display: 'flex', gap: '32px', borderBottom: `1px solid ${colors.border}`, marginBottom: '36px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {tab === 'register' && (
            <div>
              <label style={{
                ...
                letterSpacing: '0.05em', color: colors.muted, display: 'block', marginBottom: '8px',
              }}>Name</label>
              <input name="name" value={form.name} onChange={handleChange} placeholder="Your name"
                style={{
                  width: '100%', background: 'none', border: 'none',
                  borderBottom: `1px solid ${colors.border}`, padding: '8px 0',
                  fontFamily: 'Manrope, sans-serif', fontSize: '16px', color: colors.text, outline: 'none',
                }} />
            </div>
          )}
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input name="password" type={showPassword ? 'text' : 'password'}
              ...
              style={{
                width: '100%', background: 'none', border: 'none',
                borderBottom: `1px solid ${colors.border}`, padding: '8px 0',
                fontFamily: 'Manrope, sans-serif', fontSize: '16px', color: colors.text,
          ...
          <button onClick={handleSubmit} disabled={loading} style={{
            width: '100%', backgroundColor: accent, color: colors.bg, border: 'none',
