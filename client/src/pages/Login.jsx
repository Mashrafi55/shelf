...
function Login({ darkMode }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`http://localhost:5000${url}`, payload, { withCredentials: true })
  ...
  const muted = darkMode ? '#6b6860' : '#9a9490'
        ...
        <div style={{
          ...
          {['login', 'register'].map(t => (
            <button key={t} onClick={() => setTab(t)} style={{
              ...
              border: 'none',
              cursor: 'pointer',
              color: tab === t ? '#c4502e' : muted,
              paddingBottom: '12px',
              borderBottom: tab === t ? '2px solid #c4502e' : '2px solid transparent',
              marginBottom: '-1px',
